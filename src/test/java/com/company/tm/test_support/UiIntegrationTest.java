package com.company.tm.test_support;

import com.company.tm.JmixTaskManagmentApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "tm_MainScreen", screenBasePackages = "com.company.tm.screen")
@ContextConfiguration(classes = {JmixTaskManagmentApplication.class, UiTestAssistConfiguration.class})
